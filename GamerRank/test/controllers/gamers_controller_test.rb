...
class GamersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gamer" do
    assert_difference('Gamer.count') do
      post gamers_url, params: { gamer: { psn_tag: @gamer.psn_tag, steam_tag: @gamer.steam_tag, username: @gamer.username, xbox_tag: @gamer.xbox_tag } }
    end
  ...
  test "should update gamer" do
    patch gamer_url(@gamer), params: { gamer: { psn_tag: @gamer.psn_tag, steam_tag: @gamer.steam_tag, username: @gamer.username, xbox_tag: @gamer.xbox_tag } }
